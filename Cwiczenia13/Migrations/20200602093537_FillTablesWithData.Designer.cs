...
namespace Cwiczenia13.Migrations
{
    ...
    [Migration("20200602093537_FillTablesWithData")]
    partial class FillTablesWithData
    {
            ...
            modelBuilder.Entity("Cwiczenia13.Models.Zamowienie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataRealizacji = new DateTime(2020, 6, 2, 11, 35, 36, 909, DateTimeKind.Local).AddTicks(9249),
                            IdKlient = 1,
                            IdPracownik = 1,
                            Uwagi = "brak"
                        },
                        new
                        {
                            ...
                            DataRealizacji = new DateTime(2020, 6, 2, 11, 35, 36, 920, DateTimeKind.Local).AddTicks(3555),
                            IdKlient = 2,
                            IdPracownik = 2,
                            Uwagi = "brak"
                        },
                        ...
                        new
                        {
                            ...
                            DataRealizacji = new DateTime(2020, 6, 2, 11, 35, 36, 920, DateTimeKind.Local).AddTicks(3773),
                            IdKlient = 4,
                            IdPracownik = 4,
                            Uwagi = ""
                        },
                        new
                        {
                            IdZamowienia = 5,
                            DataPrzyjecia = new DateTime(2020, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataRealizacji = new DateTime(2020, 6, 2, 11, 35, 36, 920, DateTimeKind.Local).AddTicks(3799),
                            IdKlient = 5,
                            IdPracownik = 5,
                            Uwagi = ""
                        },
                        new
                        {
                            IdZamowienia = 6,
                            DataPrzyjecia = new DateTime(2020, 5, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataRealizacji = new DateTime(2020, 6, 2, 11, 35, 36, 920, DateTimeKind.Local).AddTicks(3818),
                            IdKlient = 1,
                            IdPracownik = 3,
                            Uwagi = ""
                        },
                        new
                        {
                            ...
                            DataRealizacji = new DateTime(2020, 6, 2, 11, 35, 36, 920, DateTimeKind.Local).AddTicks(3836),
                            IdKlient = 2,
                            IdPracownik = 4,
                            Uwagi = "dlugo"
                        });
